...
test_that("taxa_at", {
  ...
  for (i in list(ncbi_1, ncbi_2, itis, wfo_1, wfo_2, gbif_1, gbif_2, col)) expect_is(i, "taxa_at")
  for (i in list(ncbi_1, ncbi_2, itis, wfo_1, wfo_2, gbif_1, gbif_2, col)) expect_is(unclass(i), "list")
  for (i in list(ncbi_1, ncbi_2, itis, wfo_1, wfo_2, gbif_1, gbif_2, col)) expect_is(i[[1]], "data.frame")
  for (i in list(ncbi_1, ncbi_2, itis, wfo_1, wfo_2, gbif_1, gbif_2, col)) expect_named(i[[1]], c("name", "rank", "id"))
})
